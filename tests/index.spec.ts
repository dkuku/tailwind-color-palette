...
describe('options', () => {
	...
	it('scalemode', () => {
		const colors_lrgb = tailwindColorPalette('red', { scalemode: 'lrgb' })
		expect(colors_lrgb['brand']['100']).toEqual('#ffe4e4')
		expect(colors_lrgb['brand']['200']).toEqual('#ffc6c6')
		const colors_lab = tailwindColorPalette('red', { scalemode: 'lab' })
		expect(colors_lab['brand']['100']).toEqual('#ffd9cb')
		expect(colors_lab['brand']['200']).toEqual('#ffb299')
	})
})
